...
and if you cant update the rules, you should download and install globally firebase CLI from firebase.com and follow the steps and update the rules. it might solve the problem.

# If you can't enable Email/Password authentication method on firebase console, do this solutions:
